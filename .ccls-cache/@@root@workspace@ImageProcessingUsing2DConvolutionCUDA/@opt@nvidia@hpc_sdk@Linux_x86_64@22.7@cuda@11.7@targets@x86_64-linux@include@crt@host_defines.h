...
#if defined(__PGI) && defined (_GNU_SOURCE)
#undef __attribute__
#endif

/* CUDA JIT mode (__CUDACC_RTC__) also uses GNU style attributes */
#if defined(__GNUC__) || (defined(__PGIC__) && defined(__linux__)) || defined(__CUDA_LIBDEVICE__) || defined(__CUDACC_RTC__) || defined(__PGI)
...
#if defined(__CUDACC__) || defined(__CUDA_LIBDEVICE__) || \
    defined(__GNUC__) || defined(_WIN64) || defined(__PGI)
...
#if !defined(__CUDACC__) || (defined(__PGI) && !defined(__NVCC_HOST__))
